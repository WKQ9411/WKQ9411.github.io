...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var stars = [];
  var starCount = Math.floor(width / 15); // Responsive star count
  ...
  Star.prototype.draw = function() {
    ...
    if (this.alpha > 0.7 && this.radius > 1) {
      ctx.beginPath();
  ...
  for (var i = 0; i < starCount; i++) {
    ...
    var radius = Math.random() * 1.5 + 0.5;
